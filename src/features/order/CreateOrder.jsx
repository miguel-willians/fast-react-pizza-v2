      ...
      <Form method="POST">
        ...
        <div>
          ...
          <div>
            <input
              ...
              name="address"
              required
              className="w-full rounded-full border border-stone-200 px-4 py-2 text-sm transition-all duration-300 placeholder:text-stone-400 focus:bg-yellow-400 focus:outline-none focus:ring md:px-6 md:py-3"
            />
          </div>
        </div>
        ...
        <div>
          <input
            ...
            className="focus:outlin e-none h-6 w-6 accent-yellow-400 focus:ring focus:ring-yellow-400 focus:ring-offset-2"
          />
