...
export async function action({ request }) {
  ...
  // Não é possível chamar o dispatch fora de componentes, mas há maneiras de burlar isso, como por exemplo, importando a store diretamente no código. Entretanto, isso não deve ser feito de maneira displicente, já que desativa algumas otimizações do Redux:
